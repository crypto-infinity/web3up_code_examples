    ...
    UUPSUpgradeable
{
    ...
    address[] public childNFT_address; //keep track of minted ERC20 objects in the blockchain.
    ...
    function mint(
        ...
        //if it exist already, just mint the NFT
            ...
            _setTokenUri(tokenId, contract_uri); //if token URI is empty, token is considered fungible
